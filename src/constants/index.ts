export const API_ENDPOINTS = {
  ...
  COMPARISONS: {
    GENERATE: '/api/v1/comparisons/generate',
    CUSTOM: '/api/v1/comparisons/custom',
    GET: (taskId: string) => `/api/v1/comparisons/${taskId}`,
    SELECT: (taskId: string) => `/api/v1/comparisons/${taskId}/select`,
  },
} as const
