<template>
  <div class="experience-view">
    ...
    >
          ...
          >
            <template #default="{ row }">
              <el-button
                type="danger"
                size="small"
                @click="deleteExperience(row.experience_id)"
              >
                删除
              </el-button>
            </template>
      ...
      >
        <div
          v-for="(ruleList, scenario) in allRules"
          :key="scenario"
          class="rule-group"
        >
        ...
        <el-empty
          v-if="Object.keys(allRules).length === 0"
          description="暂无规则"
        />
      </el-tab-pane>
      ...
      >
        ...
        <el-row
          v-if="searchResults.success.length > 0 || searchResults.failure.length > 0"
          :gutter="20"
          ...
          <el-col :span="12">
            ...
            >
              <div class="result-item">
                ...
                <div
                  v-if="exp.extracted_rules.length > 0"
                  class="result-rules"
                >
                  <div
                    v-for="(rule, idx) in exp.extracted_rules"
                    :key="idx"
                    class="rule-text"
                  >
