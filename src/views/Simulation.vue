...
/* ─── Result Card ───────────────────────────────────────── */
  .result-card {
    border-left: 3px solid var(--state-success, #67A67A);
  }
...
.collision-warning {
  ...
  padding: 12px;
  margin: 12px 0;
  background: var(--state-error-bg, rgba(199, 107, 107, 0.08));
  border: 1px solid var(--state-error-border, rgba(199, 107, 107, 0.2));
  border-radius: var(--radius-sm);
}
...
.legend-bar {
  ...
  width: 14px;
  border-radius: 7px;
  background: linear-gradient(to bottom, #C76B6B, #D4A857, #67A67A, #4A90D9);
  border: 1px solid var(--bg-200);
}
