export default {
  ...
  traceTimeline: {
    ...
    prevStep: "Previous",
    nextStep: "Next",
    empty: "No reasoning steps available",
  },
  errorConflict: {
    detailTitle: "Details",
  ...
  // === RouterStatusPanel.vue Router Status Panel ===
  routerStatusPanel: {
    noDataPrefix: "No ",
    noDataSuffix: " data, please click the refresh button in the top right",
    noPrefix: "None",
    notLoadedPrefix: "Not loaded",
  },
  // === AutoDetectPanel.vue Auto Detect Panel ===
  autoDetectPanel: {
    scanHintPrefix: 'Click "',
    scanHintSuffix: '" to automatically detect installed LLM services (Ollama / LM Studio / llama.cpp / vLLM, etc.).',
    scanMethodDesc: "Scanning is based on port detection + process name identification + API health checks. <strong>No configurations will be modified</strong>.",
    scanningText: "Scanning LLM services...",
    importConfirmMessage: "All detected LLM services will be imported (existing ones with the same ID will be skipped), and the first local Provider will be automatically activated. Continue?",
  },
