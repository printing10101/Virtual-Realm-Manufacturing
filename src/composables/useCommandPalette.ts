...
export function useCommandPalette(config: CommandPaletteConfig = {}) {
  ...
  const pinyinMap: Record<string, string> = {
    ...
    '板': 'b', '搜': 's', '索': 's', '关': 'g', '闭': 'b', '切': 'q',
    '换': 'h', '设': 's', '置': 'z', '帮': 'b', '助': 'z', '关': 'g',
    '于': 'y', '我': 'w', '们': 'm', '你': 'n', '他': 't', '她': 't',
    '它': 't', '是': 's', '在': 'z', '不': 'b', '中': 'z', '大': 'd',
    '来': 'l', '上': 's', '国': 'g', '个': 'g', '到': 'd', '说': 's',
    '们': 'm', '为': 'w', '子': 'z', '和': 'h', '你': 'n', '地': 'd',
    '出': 'c', '会': 'h', '也': 'y', '对': 'd', '这': 'z', '经': 'j',
    '两': 'l', '样': 'y', '看': 'k', '着': 'z', '都': 'd', '然': 'r',
    '没': 'm', '日': 'r', '于': 'y', '起': 'q', '还': 'h', '发': 'f',
    '成': 'c', '事': 's', '只': 'z', '作': 'z', '当': 'd', '想': 'x',
    '把': 'b', '自': 'z', '那': 'n', '进': 'j', '好': 'h', '多': 'd',
    '里': 'l', '如': 'r', '果': 'g', '最': 'z', '什': 's', '么': 'm',
    '时': 's', '候': 'h', '用': 'y', '做': 'z', '去': 'q', '能': 'n',
    '让': 'r', '所': 's', '从': 'c', '而': 'e', '得': 'd', '过': 'g',
    '行': 'x', '实': 's', '现': 'x', '功': 'g', '能': 'n', '模': 'm',
    '式': 's', '系': 'x', '统': 't', '数': 's', '据': 'j', '库': 'k',
    '表': 'b', '格': 'g', '图': 't', '形': 'x', '参': 'c', '配': 'p',
    '输': 's', '入': 'r', '值': 'z', '返': 'f', '回': 'h', '结': 'j',
    '果': 'g', '错': 'c', '误': 'w', '提': 't', '示': 's', '信': 'x',
    '息': 'x', '日': 'r', '志': 'z', '记': 'j', '录': 'l', '查': 'c',
    '询': 'x', '编': 'b', '辑': 'j', '修': 'x', '改': 'g', '删': 's',
    '除': 'c', '添': 't', '加': 'j', '复': 'f', '制': 'z', '粘': 'n',
    '贴': 't', '剪': 'j', '移': 'y', '动': 'd', '排': 'p', '序': 'x',
    '升': 's', '降': 'j', '过': 'g', '滤': 'l', '分': 'f', '组': 'z',
    '统': 't', '计': 'j', '分': 'f', '析': 'x', '报': 'b', '告': 'g',
    '打': 'd', '印': 'y', '预': 'y', '览': 'l', '全': 'q', '屏': 'p',
    '缩': 's', '放': 'f', '旋': 'x', '转': 'z', '平': 'p', '视': 's',
    '角': 'j', '切': 'q', '视': 's', '图': 't', '渲': 'x', '染': 'r',
    '加': 'j', '载': 'z', '卸': 'x', '载': 'z', '刷': 's', '新': 'x',
    '重': 'c', '载': 'z', '清': 'q', '空': 'k', '缓': 'h', '冲': 'c',
    '导': 'd', '入': 'r', '文': 'w', '件': 'j', '夹': 'j', '打': 'd',
    '包': 'b', '压': 'y', '缩': 's', '解': 'j', '压': 'y', '安': 'a',
    '装': 'z', '卸': 'x', '载': 'z', '更': 'g', '新': 'x', '升': 's',
    '级': 'j', '补': 'b', '丁': 'd', '修': 'x', '复': 'f', '问': 'w',
    '题': 't', '检': 'j', '测': 'c', '测': 'c', '试': 's', '调': 'd',
    '试': 's', '运': 'y', '行': 'x', '停': 't', '止': 'z', '暂': 'z',
    '停': 't', '继': 'j', '续': 'x', '跳': 't', '过': 'g', '返': 'f',
    '回': 'h', '上': 's', '一': 'y', '步': 'b', '下': 'x', '一': 'y',
    '完': 'w', '成': 'c', '取': 'q', '消': 'x', '确': 'q', '定': 'd',
    '是': 's', '否': 'f', '通': 't', '过': 'g', '失': 's', '败': 'b',
    '成': 'c', '功': 'g', '正': 'z', '在': 'z', '等': 'd', '待': 'd',
    '加': 'j', '载': 'z', '中': 'z', '已': 'y', '完': 'w', '成': 'c',
    '错': 'c', '误': 'w', '警': 'j', '告': 'g', '提': 't', '示': 's',
    '信': 'x', '息': 'x', '详': 'x', '情': 'q', '更': 'g', '多': 'd',
    '选': 'x', '项': 'x', '配': 'p', '置': 'z', '默': 'm', '认': 'r',
    '高': 'g', '级': 'j', '设': 's', '置': 'z', '首': 's', '选': 'x',
    '项': 'x', '语': 'y', '言': 'y', '主': 'z', '题': 't', '外': 'w',
    '观': 'g', '字': 'z', '体': 't', '颜': 'y', '色': 's', '图': 't',
    '标': 'b', '准': 'z', '自': 'z', '定': 'd', '义': 'y'
  }
