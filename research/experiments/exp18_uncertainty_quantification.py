...
from research.training.experiment_tracker import start_run, is_enabled
...
def run_uncertainty_quantification_experiment():
    ...
    results = {
        ...
        "calibration": {
            "uncertainty_bins": analysis_results["uncertainty_bins"]
        }
    }
    ...
    for bin_info in analysis_results['uncertainty_bins']:
        print(f"  {bin_info['bin'].upper():8s}组: "
