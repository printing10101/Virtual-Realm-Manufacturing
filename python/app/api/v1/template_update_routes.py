...
from app.core.template_update_service import get_update_service, init_update_service
...
def scan_for_updates(req: ScanUpdatesRequest):
    ...
    return success(data={"new_notifications": len(notifications), "notifications": [n.to_dict() for n in notifications]})
