...
class GCodeGenerator:
    ...
    def _generate_feature_code(
        ...
        if "钻" in method:
            ...
            # 从几何参数获取铣削深度和范围
            mill_depth = z_depth if z_depth is not None else -5.0
            ...
            bore_x = x_pos
            bore_y = y_pos
            bore_z = z_depth if z_depth is not None else -30.0
            ...
            # 从几何参数获取五轴加工范围
            work_depth = z_depth if z_depth is not None else -3.0
