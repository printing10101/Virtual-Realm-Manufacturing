...
class AIService:
    ...
    async def call_llm(self, task_id: str, agent_name: str,
                       ...
                       model: str | None = None, max_retries: int = 3) -> dict[str, Any]:
        model_router = None
        try:
        ...
        if model_router:
            input_data = {"material": "", "tool": "", "constraints": [], "geometry": {}, "history": []}
    ...
    async def _execute_llm_call(self, prompt: str, system_prompt: str | None = None,
    ...
    async def _call_ollama(self, prompt: str, system_prompt: str | None = None,
                           model: str | None = None) -> dict[str, Any]:
        import httpx
    ...
    async def _call_cloud(self, prompt: str, system_prompt: str | None = None,
                          model: str | None = None) -> dict[str, Any]:
        import httpx
