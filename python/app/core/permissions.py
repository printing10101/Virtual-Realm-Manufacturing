...
class PaperOnlyGuard:
    def __init__(self):
        self.live_execution_enabled = os.environ.get("LNN_LIVE_EXECUTION_ENABLED", "false").lower() == "true"
    
    def is_live_execution_allowed(self) -> bool:
        return self.live_execution_enabled
    
    def check_t_operation(self, has_t_permission: bool, ui_confirmed: bool) -> tuple[bool, str]:
