...
_evolution_engine: Optional[TemplateEvolutionEngine] = None
...
def get_evolution_engine() -> TemplateEvolutionEngine:
    ...
    if _evolution_engine is None:
        with _evolution_lock:
            if _evolution_engine is None:
                _evolution_engine = TemplateEvolutionEngine()
...
def init_template_evolution(
    ...
    with _evolution_lock:
        ...
        _evolution_engine = TemplateEvolutionEngine(db_path=db_path, log_dir=log_dir)
        _evolution_engine.initialize()
    return _evolution_engine
