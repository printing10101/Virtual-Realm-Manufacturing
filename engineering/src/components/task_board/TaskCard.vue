...
.task-title { font-size: 13px; font-weight: 500; color: var(--el-text-color-primary); margin-bottom: 4px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.task-desc { font-size: 12px; color: var(--el-text-color-secondary); margin-bottom: 4px; }
.task-error { font-size: 11px; color: var(--state-error); margin-bottom: 4px; display: flex; align-items: center; gap: 4px; }
.task-footer { display: flex; justify-content: space-between; align-items: center; }
.avatar { width: 24px; height: 24px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 11px; color: #fff; }
.task-progress { display: flex; align-items: center; gap: 6px; width: 50%; }
.progress-text { font-size: 11px; color: var(--el-text-color-secondary); }
</style>
