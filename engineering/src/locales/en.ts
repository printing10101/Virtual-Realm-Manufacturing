export default {
  ...
  simulationPage: {
    ...
    msgFemWip: "FEM analysis is under development",
    msgGifWip: "GIF export is under development",
    msgMp4Wip: "MP4 export is under development",
  ...
  taskBoard: {
    ...
    msgCreateTaskWip: "New task feature is under development",
  },
  ...
  productionReport: {
    ...
    unitMinutes: "min",
    msgExportWip: "Report export feature under development",
  },
  ...
  qualityInspection: {
    ...
    msgNewInspectionWip: "New inspection feature under development",
    msgViewDetail: "View inspection details: {id}",
  },
  ...
  equipmentMonitor: {
    ...
    msgSettingsWip: "Monitor settings feature under development",
    msgViewDetail: "View equipment details: {name}",
    msgStop: "Stopping: {name}",
    msgRepair: "Repair request submitted: {name}",
  },
  ...
  materialManagement: {
    ...
    msgStockInRow: "Stock-in registration: {name}",
    msgStockInWip: "Stock-in registration feature under development",
    msgViewDetail: "View material details: {name}",
    msgPurchase: "Purchase request submitted: {name}",
  },
