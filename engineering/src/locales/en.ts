export default {
  ...
  auth: {
    ...
    guestLoginHint: "Try all features as a guest without registration",
    loginFailedHint: "Use guest mode or register an account to explore",
  ...
  agentDashboard: {
    ...
    // Activity log section (real data: Agent Gateway audit log)
    sectionActivity: "Activity Log",
    activityEmpty: "No recent activity",
    activityLoadFailed:
      "Failed to load activity log (admin permission required)",
    // Deploy dialog
  ...
  dialectManager: {
    ...
    sectionTemplates: "Template Methods",
    sectionParams: "Params (JSON)",
    btnSaveParams: "Save Params",
    paramsPlaceholder: 'Enter JSON, e.g. key "safe_z_height": 100.0',
    paramsHint: "Effective config keys",
    msgParamsInvalidJson: "Params JSON is invalid",
    msgParamsSaved: "Params saved",
    msgParamsSaveFailed: "Failed to save params",
    ...
    fieldId: "Dialect ID",
    placeholderId: "lowercase letters/digits/underscore, e.g. my_machine",
    fieldName: "Name",
    ...
    msgCreateRequired: "Please fill in dialect ID and name",
    msgCreated: "Dialect created",
    msgCreateFailed: "Failed to create dialect",
    msgTemplateSaved: "Template saved",
    msgTemplateSaveFailed: "Failed to save template",
    msgConfirmDelete: "Delete this dialect? This cannot be undone.",
    msgDeleted: "Dialect deleted",
  ...
  /** ── World Model / RL Agent (routes /world-model /rl-agent) ── */
  worldModel: {
    title: "World Model",
    subtitle: "Machining trajectory prediction and state evolution modeling",
    versionList: "Versions",
    versionDetail: "Version Detail",
    emptyVersions: "No world model versions yet",
    selectVersionHint: "Select a version on the left to view details",
    active: "Active",
    isActive: "Active",
    useForPrediction: "Use for Prediction",
    modelUriFilled: "model_uri of the active version filled in",
    loadFailed: "Failed to load world model versions",
    trajectoryPrediction: "Trajectory Prediction",
    currentState: "Current Machining State",
    candidateAction: "Candidate Action (delta)",
    horizon: "Prediction Steps",
    horizonHint: "Number of future steps to predict (1-100)",
    runPrediction: "Run Prediction",
    predictSuccess: "Trajectory prediction completed",
    predictFailed: "Trajectory prediction failed",
    predictionReady: "Prediction ready, results below",
    predictionResult: "Prediction Result",
    trajectorySteps: "Prediction Steps",
    modelInfo: {
      version: "Model Version",
      uncertainty: "Uncertainty",
    },
    metrics: {
      meanChatter: "Mean Chatter Probability",
      maxChatter: "Max Chatter Probability",
      cumulativeWear: "Cumulative Tool Wear (mm)",
      finalRoughness: "Final Surface Roughness (μm)",
    },
    fields: {
      version: "Version",
      modelUri: "Model URI",
    ...
    safetyNotice:
      "Predictions are for decision support only; physical execution requires a certified operator.",
  },
  rlAgent: {
    title: "RL Agent",
    subtitle:
      "Cutting-parameter decision agent based on historical data and offline training",
    policyVersions: "Policy Versions",
    versionDetail: "Version Detail",
    emptyVersions: "No policy versions yet",
    selectVersionHint: "Select a version on the left to view details",
    active: "Active",
    isActive: "Active",
    useForAction: "Use for Decision",
    modelUriFilled: "model_uri of the active version filled in",
    loadFailed: "Failed to load policy versions",
    actionDecision: "Action Decision",
    currentState: "Current Machining State",
    recommendedAction: "Recommended Action",
    candidateActions: "Candidate Actions",
    actionEvaluations: "Candidate Evaluation Details",
    actionIndex: "Candidate #",
    decisionReady: "Decision ready, results below",
    decisionResult: "Decision Result",
    safe: "Safety constraints satisfied",
    violation: "Safety constraints violated",
    optimizationTarget: "Optimization Target",
    runDecision: "Run Decision",
    actSuccess: "Decision completed",
    actFailed: "Decision failed",
    noTrainingStatus: "No training status yet",
    ...
    fields: {
      ...
      modelUri: "Model URI",
      algorithm: "Algorithm",
      trainingEpisodes: "Training Episodes",
    ...
    training: {
      ...
      startConfirm:
        "Start offline PPO training? A real trajectory dataset must be configured.",
      startSuccess: "Training started",
      startFailed: "Failed to start training",
      stopTitle: "Stop Training",
      stopConfirm: "Request to stop the current training?",
      stopSuccess: "Stop request sent",
      stopFailed: "Failed to stop training",
      offlineNotice:
        "v1 supports offline training only: replay of real historical trajectories, no real machine connection.",
      errorOccurred: "Training error",
    },
    safetyNotice:
      "Actions are for CAM validation and logs only; they are never sent directly to CNC controllers.",
  },
};
