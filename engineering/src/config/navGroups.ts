...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/task-board", label: "任务中心", icon: List },
  ...
  },
  {
    label: "市场与工具",
    items: [
      { path: "/template-market", label: "模板中心", icon: FolderOpened },
      { path: "/plugins", label: "插件中心", icon: Connection },
  ...
  {
    label: "系统与帮助",
    items: [{ path: "/about", label: "关于", icon: Service }],
  },
];
